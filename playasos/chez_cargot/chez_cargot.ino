...
/*
 * Pattern that creates that blossoms out from the center, like a flower.
 */
...
/*
 * See flowerOrbPattern, uses RGB Palettes
 */
...
/*
 * See flowerOrbPattern, uses the group hue to cycle through a palette with
 * different groups being assigned to different rings.
 */
...
/*
 * See flowerOrbPattern, uses the rainbow hue to cycle through a palette.
 */
...
/*
 * Pattern that lights up random orbs - similar to randomSparklesPattern but at
 * a per-orb level.
 */
...
/*
 * See randomOrbsPattern - cycles through a palette using the rainbow hue.
 */
...
/*
 * See randomOrbsPattern - cycles through a palette using the group hue.
 */
...
/*
 * See randomOrbsPattern - sets all of the orbs equally across the palette as a
 * gradient.
 */
...
/*
 * See ringsPattern - uses the rainbow hue to set an even gradient across all
 * LED's.
 */
...
/*
 * See ringsPattern - uses the group hue to set an even gradient across all
 * LED's in a given ring.
 */
...
/*
 * Creates a spiral by lighting up individual orbs and spiraling outward from
 * the center.
 */
...
/*
 * See spiralPattern - spirals outward at a steady interval.
 */
...
/*
 * See spiralPattern - spirals outward and inward at a steady interval.
 */
...
/*
 * See spiralPattern - spirals outward at a dynamic interval (set via a sine
 * wave).
 */
...
/*
 * See spiralPattern - spirals outward and inward at a dynamic interval (set
 * via a sine wave).
 */
